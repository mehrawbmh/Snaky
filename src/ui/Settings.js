...
export class Settings {
    constructor() {
        ...
        if (savedSettings) {
            this.playerName = savedSettings.playerName;
            this.snakeColor = savedSettings.snakeColor;
            this.template = savedSettings.template;
            this.obstacleColorMode = savedSettings.obstacleColorMode;
            this.singleObstacleColor = savedSettings.singleObstacleColor;
            this.bulletColor = savedSettings.bulletColor;
            this.bulletSize = savedSettings.bulletSize;
            this.bulletSpeed = savedSettings.bulletSpeed;
            this.showScoreboard = savedSettings.showScoreboard;
            this.showLogging = savedSettings.showLogging;
            this.enableFoodEffects = savedSettings.enableFoodEffects;
            this.enableWalls = savedSettings.enableWalls;
            this.wallColor = savedSettings.wallColor;
            this.showStatus = savedSettings.showStatus;
    ...
    applySettings() {
        ...
        saveSettings(this.getAllSettings())
        this.closeSettings();
